...
transtime <- round(transition_time[which.min(lm_coeff[2,])])
...
cir_seq <- read.csv("H3N2_HA_HK_sequence.csv") # "H3N2_NA_HK_sequence.csv" for NA protein
pre_seq <- read.csv("CombinedH3N2_HA_Wildtype.csv") # "CombinedH3N2_NA_Wildtype.csv" for NA protein
